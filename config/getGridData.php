...
define('DB_NAME', 'tablaquirurgica');
define('DB_USER','rebsolll');
define('DB_PASSWORD','iopa2018');
...
$result = mysql_query("SELECT COUNT(*) AS count FROM solicitud");
...
$SQL = "SELECT * from solicitud ORDER BY $sidx $sord LIMIT $start , $limit"; 
